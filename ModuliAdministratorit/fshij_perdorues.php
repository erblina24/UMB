									...
									<div class="content">
										...
										<form method="post" action="">
											<table>
												<tbody>
													<tr>
														...
														<td>
															<input type="text" name="term" placeholder="Emri ose Emaili" value="%"/>
														</td>
                                            ...
                                            if (!empty($_REQUEST['term'])) {
                                                ...
                                                $sql = mysqli_query($lidh_sp ,
                                                "CALL SelektoPerdoruesitTerm('$term')"); 
                                                while($rresht = mysqli_fetch_array($sql)) { 		
                                                    ...
                                                    echo "<td><a href=\"fshij.php?ID_Perdoruesi=$rresht[ID_Perdoruesi]\"  onClick=\"return confirm('A jeni te sigurt se deshironi te fshini te dhenen?')\" class='button primary small'>Fshijë</a> </td> </tr>";				
                                                }
