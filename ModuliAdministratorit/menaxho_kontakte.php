							...
							<section  class="main">
								<div class="spotlight">
									<div class="content">
										...
										<h3>KËRKO KONTAKTET  PËR MENAXHIM</h3>
										...
										if (!empty($_REQUEST['term'])) {
											...
											$sql = mysqli_query($lidh_k,"CALL SelektoKontaktTerm('$term')");	
											...
											while($rresht = mysqli_fetch_array($sql)) { 		
													...
													echo "<td><a href=\"fshij_kontakt.php?ID_Kontakti=$rresht[ID_Kontakti]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini te dhenen?')\" class='button primary small'>Fshije</a> </td>";
											}
